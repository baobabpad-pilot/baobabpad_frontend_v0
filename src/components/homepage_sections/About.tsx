...
const About = () => {
  return (
    <div className="px-3 sm:px-6 md:px-20 lg:px-40 p-4 flex flex-col gap-8">
      <div className="mt-10">
        <h1 className="font-bold text-3xl lg:text-5xl">
          Virtual Technology Village
        </h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 text-xl">
        <div className="p-2 lg:px-10 flex flex-col gap-10">
          <p>
          ...
          <div className="lg:hidden flex h-40 sm:h-80 w-full relative rounded overflow-hidden">
            <Image
        ...
        <div className="h-full gap-4 hidden lg:flex flex-col">
