...
import Management from "@/components/baobabpad_sections/Management";
import AdvisoryTeam from "@/components/baobabpad_sections/AdvisoryTeam";
    ...
    <div className="min-h-screen flex flex-col">
      <Layout>
        ...
        <section className="border-t border-500  md:flex items-center flex-wrap p-10">
          <div className="flex flex-col justify-center md:w-[60%] w-[100%] gap-y-5  p-4">
            ...
            <div className="flex flex-row gap-x-4 items-center">
              ...
              <span className="text-[#9095A0] font-[1.125rem] cursor-pointer hover:bg-[#00BDD6] hover:border  hover:text-[#FFF] hover:p-[0.4rem]  hover:rounded-[1rem]">
                Learn More
              </span>
            </div>
          ...
          <div className="border border-white-100 bg-[#F5F2FD] flex flex-col w-[30.625rem] h-[22.625rem] p-8">
            ...
            <div className="flex flex-row justify-around">
              <div className="flex flex-col justify-center">
                ...
                <div>
                  <span className="p-4 text-[2rem] font-bold font-700">
                    +40%
                  </span>
                </div>
              </div>
        ...
        <section className="bg-[#F8F9FA] flex flex-col items-center mt-8 p-6 gap-y-4 ">
          <div>
            <span className="text-[2rem] font-medium text-[#341473]">
              Featured by:
            </span>
          </div>
