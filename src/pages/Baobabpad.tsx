    ...
    <div className="min-h-screen flex flex-col">
      <Layout>
        ...
        <section className=" md:flex gap-5 ">
          ...
          <div
            className="bg-cover bg-opacity-100 py-[6rem] h-[100%] md:w-[60%] w-[100%] mt-2 rounded-l-lg  "
            style={{ backgroundImage: `url('aboutbg.png')` }}
          >
            {/*Vission  div*/}
            <div className=" md:flex flex-row gap-[40%] mt-[50%] mb-[10%]">
              <p className="text-violet-600  mb-6 text-5xl font-bold  md:ml-[-60%] ml-5 mt-5">
                VISION
              </p>
              <div className="flex gap-4  bg-white opacity-90 w-[90%] mx-auto my-auto rounded-md h-[50%]">
                ...
                />
                <p className="p-4 shadow-md text-xl font-medium">
                  Elevating African Talent, Virtually and Globally.
                </p>
              </div>
            </div>
            {/*Mission  div*/}
            <div className="md:flex flex-row gap-[35%] ">
              <p className="text-blue-600 text-5xl font-bold  md:ml-[-60%] ml-5 mt-6">
                MISSION
              </p>
              <div className="flex gap-4 bg-white opacity-90 w-[90%] mx-auto rounded-md h-[50%] my-auto">
                ...
                />
                <p className="p-4 shadow-md text-xl font-medium">
                  Empowering African Talents through a bustling ecosystem that
                  harnesses the immense potential of Africa's tech-experts to
                  the world.{" "}
                </p>
              </div>
            </div>
        ...
        <section
          id="why-baobabpad"
          className="border-t border-500  md:flex items-center flex-wrap p-10 "
        >
          <div className="flex flex-col justify-center md:w-[60%] w-[100%] gap-y-5  p-4">
            <div className="flex flex-col ">
              <span className="font-bold text-5xl text-[#323842]">
                Why Baobabpad
              </span>
            </div>
        ...
        >
          ...
          <div className="md:text-lg text-sm border border-white-100 bg-[#F5F2FD] flex flex-col w-[30.625rem] h-[22.625rem] p-8">
            ...
            <span className="text-justify ">
              Working with Baobabpad DevOps empowers our clients to faster
              software delivery by streamlining the development and deployment
              process. Our clients are able to optimize new features and
              products to market more quickly. Our competitive business
              advantage is:{" "}
            </span>
            ...
            <div className="flex flex-row justify-around">
              <div className="flex flex-col justify-center">
                ...
                <div>
                  <span className="p-4 md:text-[2rem] text-[1.5rem] font-bold font-700">
                    +45%
                  </span>
                </div>
              </div>
        ...
        <section className="hidden md:flex flex-col justify-center mt-7 ">
          ...
          <div className="flex justify-center  flex-wrap gap-x-7 gap-y-7  ">
            <div className=" flex flex-col p-4 gap-y-5 shadow-2xl hover:transform hover:scale-100 transition-transform duration-300 hover:cursor-pointer">
              ...
              <div>
                <span className="bg-[#EBFDFF] text-[#00BDD6] text-[0.7rem] p-1 rounded-[1rem]">
                  Impact
                </span>
              </div>
            </div>
            <div className="flex flex-col p-4 gap-y-5 shadow-2xl hover:transform hover:scale-100 transition-transform duration-300 hover:cursor-pointer ">
              <img
                src="/kenny.png"
                alt="Kenny's photo"
                className="w-[19rem] h-[17rem] mx-auto "
              />
              <Link href="#Mentorship" onClick={toggleMentorship}>
                <span
                  id="pasi"
                  className="text-[1.5rem] font-bold hover hover:text-[#00BDD6]  w-[100%]"
                >
                  <p className="  text-center ">Growth Mentorship</p>
                </span>
              </Link>
              {showMentor && <Mentorship />}

              <div>
                <span className="bg-[#F1F4FD] text-[#4069E5] text-[0.7rem] p-1 rounded-[1rem]">
                  Human Capital
                </span>
              </div>
            </div>
        ...
        <section className="bg-[#F8F9FA] flex flex-col items-center mt-8 p-6 gap-y-4 ">
          <div>
            <span className="text-[2rem] font-medium text-[#341473] mb-">
              Featured by:
            </span>
          </div>
          ...
          <div className="flex md:flex-col-3 flex-row-3 gap-[10%] ">
            <div className="w-[20%] ml-12 md:mb-5  ">
              <div className="md:h-[75%] h-[70%] w-full shadow-2xl hover:transform hover:scale-110 transition-transform duration-300">
                <img
                  src="/NF.jpg"
                  alt=" startup extreme logo"
                  className="w-full h-full"
                />
              </div>
              <div className="mt-7">
                <Link
                  href="https://open.spotify.com/episode/0iV5UHXUqLtg7Z9gKEluNF?si=cdCQIVtHQS2x2lXGy-XsKg"
                  className="mt-4"
                >
                  <span className="text-xl font-medium text-gray-800 mt-11 hover hover:text-[#00BDD6] h-[40%] my-auto">
                    Next frontier
                  </span>
                </Link>
              </div>
            ...
            <div className="w-[20%]">
              <div className="h-[70%] w-full  shadow-2xl hover:transform hover:scale-110 transition-transform duration-300">
                <img
                  src="/Nature.jpg"
                  alt="nature backend Logo"
                  className="w-full h-full rounded-lg"
                />
              </div>
              <div className="mt-7">
                <Link
                  href="https://naturebacked.com/episode/how-to-fix-carbon-markets-with-kenny-kaluiji"
                  className="mt-4"
                >
                  <span className="text-xl font-medium text-gray-800 mt-11 hover hover:text-[#00BDD6] h-[40%] my-auto">
                    Nature Backend
