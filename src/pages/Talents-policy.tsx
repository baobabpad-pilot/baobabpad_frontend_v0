...
import Anti_corruption from "@/components/Talents-policy/Anti_corruption";
import Diversity from "@/components/Talents-policy/Diversity";
                ...
                <div className="grid md:grid-cols-2 gap-5 bg-[#12BC7E] md:h-[20rem] h-[30rem] p-4 rounded-lg">
                 ...
                 <div className="md:flex gap-5 my-[4rem]">
                    ...
                    <div className="w-[30%] hidden  md:grid grid-rows-5  gap-[4rem] h-[100%] mt-[2rem]">
                        ...
                        <a 
                          href="#"
                          onClick={(event) => handleClick(event, "Anti_corruption")}
                          className="hover hover:text-green-600 font-medium">
                            <span>5. Anti-Corruption Policy </span>
                        </a>
                        <a 
                          href="#"
                          onClick={(event) => handleClick(event, "Diversity")}
                          className="hover hover:text-green-600 font-medium">
                            <span>6. Diversity</span>
                        </a>
                    ...
                    {/*right part*/}
                    <div className="md:w-[70%] md:mt-0 mt-[2rem] md:h-[500px] md:overflow-auto pr-2">
                    ...
                    {componentVisible === "Anti_corruption" && <Anti_corruption/>}
                    {componentVisible === "Diversity" && <Diversity/> }
                       {!componentVisible && (
                 ...
                 <div className="md:flex justify-between w-[90%] mx-auto my-[2rem] md:h-[2.5rem] h-[8rem] ">
                    ...
                    <a  href="/Talents-Terms.pdf" download="Terms of service.pdf"  className=" download-button flex gap-1  text-blue-500 bg-white rounded-lg px-2 py-2 items-center hover  hover:text-blue-900 md:w-[15%] w-[50%] md:mb-0 mb-[2rem] md:mx-0 mx-auto border border-gray-200"><MdOutlineFileDownload className="text-blue-500 ml-2"/>
